        ...
        submitHandler: function (form) {
                ...
                }).then(response =>
            {
                ...
                if(js["ERROR"] === undefined && data !== undefined) {
                    ...
                    document.cookie = `user_id=${js["user_id"]}; expires=${expires.toUTCString()}; path=/ `;
                    document.cookie = `user=${js["user"]}; expires=${expires.toUTCString()}; path=/ `;
